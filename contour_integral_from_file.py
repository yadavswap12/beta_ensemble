# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 12:48:40 2020

@author: yadav
"""

#code for contour integral of a complex function arranged in array, on given contour
#inputs c is an array of x,y on contour and f is a complex function (integrand) 
#f is an array of the form f(x),x and should be predefined in a code in which contr_intgl(c,f) is called
import math
import cmath
import numpy
